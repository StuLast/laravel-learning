                    ...
                    <div class="card-body">
                        <form action="/tag/{{$tag->id}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->has('name') ? 'border-danger': ''}}" id="name" name="name" value="{{$tag->name ?? old('name')}}" onInput="updateButton(event)">
                                <small class="form-text text-danger">{!!$errors->first('name')!!}</small>
                            </div>
                            <div class="form-group">
                               Example:  <button id="demo_button" class="btn {{'btn-'.$tag->style?? 'btn-'.old('style') ?? 'btn-light'}}" onClick="event.preventDefault()">{{$tag->name ?? old('name') ?? 'button'}}</button>
                            </div>
                            <div class="form-group">
